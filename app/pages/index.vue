  ...
  <div class="flex h-screen bg-gray-50 font-sans">
    ...
    <aside class="w-64 shrink-0 bg-white border-r border-gray-200 flex flex-col">
      ...
      <nav class="flex-1 overflow-y-auto p-3 space-y-0.5">
        ...
        >
          <span>All Tasks</span>
          <span class="text-xs tabular-nums" :class="selectedCategoryId === null ? 'text-indigo-500' : 'text-gray-400'">
            {{ todos.length }}
          </span>
        </button>
        ...
        >
          ...
          <span class="text-xs tabular-nums shrink-0 ml-2" :class="selectedCategoryId === cat.id ? 'text-indigo-500' : 'text-gray-400'">
      ...
      <div class="p-3 border-t border-gray-200">
        <form v-if="addingCategory" class="flex gap-2" @submit.prevent="submitCategory">
          <input
            ref="categoryInput"
          ...
          >
          <button type="submit" class="text-sm px-3 py-1.5 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors">
            Add
          </button>
        </form>
        <button
